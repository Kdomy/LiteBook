package com.kdomy.litebook.ui.viewmodel

import android.app.Application
import androidx.lifecycle.AndroidViewModel
import androidx.lifecycle.viewModelScope
import com.kdomy.litebook.data.local.SettingsDataStore
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.MATERIAL_YOU
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.AMOLED_BLACK
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.DESKTOP_LAYOUT
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.ENABLE_COPY_TO_CLIPBOARD
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.ENABLE_DOWNLOAD_CONTENT
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.HIDE_GROUPS
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.HIDE_PEOPLE_YOU_MAY_KNOW
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.HIDE_REELS
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.HIDE_STORIES
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.HIDE_SUGGESTED
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.IMMERSIVE_MODE
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.PINCH_TO_ZOOM
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.REMOVE_ADS
import com.kdomy.litebook.data.local.SettingsDataStore.Companion.STICKY_NAVBAR
